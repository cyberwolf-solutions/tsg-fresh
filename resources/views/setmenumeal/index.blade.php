        ...
        <div class="card">
            <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($data as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        @can('edit rooms')
                                            <a href="javascript:void(0)" data-url="{{ route('setmenumeal.update', $item->id) }}"
                                                data-name="{{ $item->name }}"
                                        ...
                                        @can('delete rooms')
                                            <a href="javascript:void(0)"
                                                data-url="{{ route('setmenumeal.destroy', [$item->id]) }}"
                ...
                <div class="row">
                    ...
                    <div class="mt-3">
                        <form method="POST" class="ajax-form" action="{{ route('setmenumeal.store') }}">
                            @csrf
                            <div class="row">
