                ...
                <form method="POST" class="ajax-form"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="p_no" id="" class="form-control"
                                value="{{ $is_edit ? $data->passport_no : '' }}" placeholder="Enter Passport Number" />
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="" class="form-label">Next Destination</label>
                            <textarea class="form-control" name="n_destination" id="" rows="1" placeholder="Enter Dstination">{{ $is_edit ? $data->next_destination : '' }}</textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
