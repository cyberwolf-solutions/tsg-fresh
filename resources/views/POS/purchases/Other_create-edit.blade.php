        ...
        <div class="card">
            <div class="card-body">
                <form method="POST" class="ajax-form" id="purchase-form"
                    action="{{ $is_edit ? route('opurchases.update', $data->id) : route('opurchases.store') }}">
                    @csrf
                    @if ($is_edit)
                        @method('PATCH')
                    @endif
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="" id="" class="form-control"
                                value="{{ $settings->otherpurchase($is_edit ? $data->id : $latest) }}" readonly disabled />
                        </div>
                                    ...
                                    @if ($is_edit)
                                        @foreach ($data->items as $item)
                                            <tr data-id="{{ $item->product_id }}">
                                                ...
                                                {{-- <td data-id="{{ $item->product_id }}">{{ $item->product->name ?? 'N/A' }}</td> --}}
                    ...
                    <div class="row mb-3">
                        <div class="col-12 text-end">
                            <button type="button" class="btn btn-light me-2"
                                onclick="window.location='{{ route('opurchases.index') }}'">Cancel</button>
