        ...
        <div class="card">
            <div class="card-body">
                                    ...
                                    <td>
                                        @can('edit rooms')
                                            <a href="javascript:void(0)"
                                                data-url="{{ route('additional-payments.update', $item->id) }}"
                                        ...
                                        @can('delete rooms')
                                            <a href="javascript:void(0)"
                                                data-url="{{ route('additional-payments.destroy', [$item->id]) }}"
                ...
                <div class="row">
                    ...
                    <div class="mt-3">
                        <form method="POST" class="ajax-form" action="{{ route('additional-payments.store') }}">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3 ">
                                    ...
                                    <textarea name="list" id="list" class="form-control" placeholder="Enter List"></textarea>
                                </div>
                            </div>
...
@section('script')
    <script>
        ...
        //     var list = $(this).data('description');
