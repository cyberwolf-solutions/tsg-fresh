    ...
    <div class="row mt-3">
        <div class="card">
            <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($data as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        @can('edit rooms')
                                            <a href="javascript:void(0)" data-url="{{ route('room-size.update', $item->id) }}"
                                                data-size="{{ $item->size }}"
                                        ...
                                        @can('delete rooms')
                                            <a href="javascript:void(0)"
                                                data-url="{{ route('room-size.destroy', [$item->id]) }}"
                ...
                <div class="row">
                    <h4 class="topic">Add Room Size</h4>
                    <div class="mt-3">
                        <form method="POST" class="ajax-form" action="{{ route('room-size.store') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6 mb-3 required">
                                    <label for="" class="form-label">Room Size (m2)</label>
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    <button class="btn btn-primary btn-action">Add</button>
                                </div>
                            </div>
                        </form>
                    </div>
