                ...
                <div class="row mt-3">
                    @can('create units')
                        ...
                        <div class="col d-flex gap-2">
                            <a href="{{ route('coupon.create') }}" class="btn btn-sm btn-purple" style="  color: white;">
                        ...
                        <tbody>
                            @foreach ($data as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        @can('view units')
                                            <a data-url="{{ route('units.show', [$item->id]) }}"
                                        ...
                                        @endcan
                                        @can('delete units')
                                            <a href="javascript:void(0)" data-url="{{ route('units.destroy', [$item->id]) }}"
