        ...
        <div class="card">
            <div class="card-body">
                <form method="POST" class="ajax-form"
                    action="{{ $is_edit ? route('inventory.update', $data->id) : route('inventory.store') }}">
                    @csrf
                    @if ($is_edit)
                        @method('PATCH')
                    @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3 required">
                            ...
                            <input type="text" name="min_quantity" id="" class="form-control"
                                   value="{{ $is_edit ? $data->min_quantity : '' }}" placeholder="Enter Alert Quantity" required />
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row mb-3">
                        <div class="col-12 text-end">
                            <button type="button" class="btn btn-light me-2"
                                onclick="window.location='{{ route('inventory.index') }}'">Cancel</button>
