<header id="headerWrapper" style="position: fixed; top: 0; left: 0; width: 100%; z-index: 9999; transition: transform 0.3s ease-in-out;">
    <!-- Blue Top Bar -->
    <div id="topBar" style="background-color: rgb(0, 120, 206); height: 30px; display: flex; align-items: center; justify-content: space-between; padding: 0 15px; font-size: 11px;">
        ...
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <a href="{ route('landing.contact') }}" style="color: rgb(228, 228, 228); text-decoration: none;">Contact Us</a>
            <span style="color: rgb(228, 228, 228);">|</span>
    ...
    <!-- Main Navigation -->
    <nav style="height: 60px; background-color: white; display: flex; align-items: center; justify-content: space-between; padding: 0 20px;">
        <!-- Left Links -->
        <ul style="display: flex; list-style: none; gap: 20px; margin: 0; padding: 0;">
            <li><a href="#" class="nav-link active">HOME</a></li>
            <li><a href="#" class="nav-link">ABOUT US</a></li>
            <li><a href="#" class="nav-link">SHOP NOW</a></li>
        </ul>
