        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    {{-- Add Buttons Here --}}
                    @can('create tables')
                        <a href="{{ route('tables.create') }}" class="btn btn-primary btn-icon" data-bs-toggle="tooltip"
                            title="Create">
                        ...
                        <tbody>
                            @foreach ($data as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        @can('view tables')
                                            <a data-url="{{ route('tables.show', [$item->id]) }}"
                                        ...
                                        @endcan
                                        @can('delete tables')
                                            <a href="javascript:void(0)" data-url="{{ route('tables.destroy', [$item->id]) }}"
