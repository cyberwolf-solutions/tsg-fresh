...
class TACheckoutController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($checkout && $room) {
                ...
                $viewData = [
                    'data' => $checkout,
                    // 'settings' => $settings, // Ensure $settings is defined and contains necessary data
                ];
                ...
                if ($result) {
                    ...
                    return response()->json(['message' => 'Failed to send E-bill']);
                }
            }
        } catch (\Throwable $th) {
